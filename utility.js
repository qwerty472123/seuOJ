...
module.exports = {
  ...
  gravatar(email, size, useLocalLibs) {
    return gravatar.url(email, { s: size, d: 'mm', r: 'g' }).replace('//www.gravatar.com/avatar', useLocalLibs ? (syzoj.config.local_gravatar_url === 'inner' ? '/gravatar' : syzoj.config.local_gravatar_url) : syzoj.config.gravatar_url);
  },
